...
# Exact mappings for high-signal skills to avoid falling into "other".
EXACT_CATEGORY_MAP = {
    "ask": "utilities",
...
def main():
    ...
    # Output YAML to help scripts directory
    output_path = Path('.claude/skills/help/scripts/skills_data.yaml')
    ...
    legacy_path.write_text(
        "# Skills catalog moved to .claude/skills/help/scripts/skills_data.yaml\n"
