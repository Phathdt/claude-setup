...
python $HOME/.claude/scripts/generate_catalogs.py --skills

# Generate skills catalog to file
python $HOME/.claude/scripts/generate_catalogs.py --skills --output guide/SKILLS.yaml

# Write to file instead of stdout
python $HOME/.claude/scripts/generate_catalogs.py --skills --output guide/SKILLS.yaml

# View help
python $HOME/.claude/scripts/generate_catalogs.py --help
```
