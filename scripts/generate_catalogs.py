...
def load_yaml(filename):
    ...
    # skills_data canonical source moved under help skill.
    # SCRIPT_DIR is .claude/scripts/, parent is .claude/
    if filename == 'skills_data.yaml':
        canonical = SCRIPT_DIR.parent / 'skills' / 'help' / 'scripts' / 'skills_data.yaml'
        if canonical.exists():
...
def generate_commands_yaml():
    ...
    catalog = {
        'metadata': {
            ...
            'description': 'Auto-generated catalog of all available commands in Claude Code Kit Engineer',
...
def generate_skills_yaml():
    ...
    catalog = {
        'metadata': {
            ...
            'description': 'Auto-generated catalog of all available skills in Claude Code Kit Engineer',
            'last_updated': datetime.now().strftime('%Y-%m-%d'),
