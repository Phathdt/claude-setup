...
pip install -r $HOME/.claude/skills/ai-multimodal/scripts/requirements.txt
...
```bash
cd $HOME/.claude/skills/ai-multimodal/scripts
...
**ai-multimodal** (`$HOME/.claude/skills/ai-multimodal/scripts/requirements.txt`):
...
```bash
cd $HOME/.claude/skills/{skill-name}/scripts
...
2. **`$HOME/.claude/skills/{skill-name}/.env`** (skill-specific config)
3. **`$HOME/.claude/skills/.env`** (shared skills config)
...
```bash
chmod +x $HOME/.claude/skills/*/scripts/*.py
```
...
# Run all tests
pytest $HOME/.claude/skills/*/scripts/tests/ -v

# Check coverage across all skills
pytest $HOME/.claude/skills/*/scripts/tests/ --cov=.claude/skills --cov-report=html
```
